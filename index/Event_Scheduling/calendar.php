...
if (isset($_SESSION['username'])) {
    ?>
    <p><a href="create_event.php">Click Here to Create an Event</a></p>
    <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($eventDateTime <= $todaysDate) {
            ?>
            <div class="event-details">
                <h3>The date you entered was invalid. Please select a date that has not passed. </h3> <br>
            </div>
            <?php
        } else {
            $sql = "INSERT INTO Calendar (User_ID, Date, Data) VALUES (?, ?, ?)";
            ...
            ?>
            <div class="event-details">
                <?php echo "Event Created Successfully <br><br>"; ?>
            </div>
            <?php
        }
